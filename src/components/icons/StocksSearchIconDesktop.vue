...
<template>
    <svg v-if="inWatchlist" id="svgCheckCirckle2" @click="inWatchlistClick" @mouseenter="mouseenter" @mouseleave="mouseleave" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16">
    ...
    <svg v-else id="svgPlusCircle" @click="notInWatchlistClick" @mouseenter="mouseenter" @mouseleave="mouseleave" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16">
